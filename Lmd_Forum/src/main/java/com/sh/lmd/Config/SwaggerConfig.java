...
public class SwaggerConfig {
    ...
    public ApiInfo createA(){
        ApiInfo info=new ApiInfoBuilder().title("论坛中心").
                contact( new Contact("辉哥","http://www.mobiletrain.org","xingfei_work@163.com")).
                description("欢迎大家探讨问题").build();
        return info;
    }
    /**
     * 创建API应用
    ...
    public Docket createDocket(){
       Docket docket=new Docket(DocumentationType.SWAGGER_2).apiInfo(createA()).select().
               apis(RequestHandlerSelectors.basePackage("com.sh.lmd.controller")).
               build();
       return docket;
    }
}